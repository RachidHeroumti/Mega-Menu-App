!(function (e, t) {
  ...
  const route = window.localStorage.getItem("Storeino-app-route");
  ...
  if (!token && !route) {
    ...
    loginImg.setAttribute(
      "src",
      "https://storeno.b-cdn.net/stores/3-2021/1617016802422.png"
    );
    loginImg.classList.add("logo");
  
    // - - - -
    var iconUser = document.createElement("img");
    iconUser.setAttribute(
      "src",
      "https://storeno.b-cdn.net/stores/3-2021/1617015731453.png"
    );
    iconUser.classList.add("icon");
  
    // - - - -
    var text = document.createElement("p");
    text.innerText = "SIGN IN YOUR ACCOUNT";
    text.classList.add("text");
  
    // - - - -
    var inputEmail = document.createElement("INPUT");
    inputEmail.setAttribute("type", "email");
    inputEmail.setAttribute("placeholder", "Entre Email");
    inputEmail.classList.add("email");
  
    // - - - -
    var inputPassword = document.createElement("INPUT");
    inputPassword.setAttribute("type", "password");
    inputPassword.setAttribute("placeholder", "Entre Password");
    ...
    divForm.appendChild(loginImg);
    divForm.appendChild(iconUser);
    ...
    loginStyle.innerText = `
      ...
      .icon {
        ...
        border-radius: 50%;
        background: #B5BBDB;
        box-shadow:1px 4px 9px -2px #e4e2e2
      }
      .form-login::before {
        content: '';
        position: absolute;
    ...
    btnSubmit.addEventListener("click", async (e) => {
      ...
      inputEmail.style.border = "1px solid #111";
      inputPassword.style.border = "1px solid #111";
      ...
      function messageError() {
        ...
        err.innerText = "Invalid Email and Password";
  
        // - - - -
        var btn = document.querySelector(".content-form");
        btn.insertBefore(err, btn.childNodes[5]);
      ...
      try {
        ...
        if (email != null && email != "" && password != null && password != "") {
          ...
          var res = await http.post(
            `https://api-managers.storeino.com/api/users/login`,
            {
              email: email,
              password: password,
            }
          ...
          // - - - -
          var stores = await http.get(
            `https://api-managers.storeino.com/api/users/me`,
            {
              headers: {
          ...
          if (stores.data.stores.length > 0) {
            // - - - -
            inputEmail.classList.add("hidden-form-login");
            inputPassword.classList.add("hidden-form-login");
            btnSubmit.classList.add("hidden-form-login");
            text.classList.add("hidden-form-login");
            ...
            setTimeout(() => {
              ...
              // - - - -
              inputEmail.classList.remove("hidden-form-login");
              inputPassword.classList.remove("hidden-form-login");
              btnSubmit.classList.remove("hidden-form-login");
              text.classList.remove("hidden-form-login");
  
              // - - - -
              var storesApp = document.createElement("div");
              storesApp.classList.add("str");
  
              // - - - -
              stores.data.stores.forEach((ele) => {
                // - - - -
                var divRadio = document.createElement("div");
                divRadio.classList.add("card");
  
                // - - - -
                var radio = document.createElement("input");
                radio.setAttribute("type", "radio");
                radio.setAttribute("name", "store");
                radio.setAttribute("id", `${ele.name}`);
                radio.setAttribute("value", `${ele._id}`);
  
                // - - - -
                var label = document.createElement("label");
                label.setAttribute("for", `${ele.name}`);
                label.innerText = ele.subdomain;
  
                // - - - -
                var error = document.createElement("span");
                error.classList.add("radio-err");
                error.innerText = "*";
  
                // - - - -
                divRadio.appendChild(radio);
                divRadio.appendChild(label);
                divRadio.appendChild(error);
  
                // - - - -
                storesApp.appendChild(divRadio);
              });
  
              // - - - -
              divForm.appendChild(storesApp);
  
              // - - - -
              var nameRoute = document.createElement("input");
              nameRoute.setAttribute("type", "text");
              nameRoute.setAttribute("placeholder", "Entre Route");
              nameRoute.classList.add("routeName");
  
              // - - - -
              divForm.appendChild(nameRoute);
              ...
              btnSubmit.addEventListener("click", async (e) => {
                ...
                // - - - -
                var checked = document.querySelectorAll('input[name="store"]');
                var routeValue = document.querySelector(".routeName");
                ...
                if (id != null) {
                  // - - - -
                  var xToken = await http.get(
                    `https://api-stores.storeino.com/api/stores/get?id=${id}&withToken=true`,
                    {
                      headers: {
                        "x-auth-token": res.data.token,
                      },
                  ...
                  // - - - -
                  if (xToken.data.token && routeName != "" && routeName != null) {
                    window.localStorage.setItem("Storeino-app-route", routeName);
                  ...
                  // - - - -
                  var rd = document.querySelector(".radio-err");
  ...
  function admin() {
    ...
    (async () => {
      ...
      // - - - -
      var submitBarStyle = document.createElement("style");
